            ...
            <div class="flex flex-wrap justify-center -mx-3">
                <div class="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                    <div class="h-full p-6 md:p-12 border">
                        <div class="flex items-center">
                            <span
                                class="flex-shrink-0 inline-flex mr-4 md:mr-10 items-center justify-center w-20 h-20 bg-blue-300 rounded-full">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                    <div class="h-full p-6 md:p-12 border">
                        <div class="flex items-center">
                            <span
                                class="flex-shrink-0 inline-flex mr-4 md:mr-10 items-center justify-center w-20 h-20 bg-indigo-300 rounded-full">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-3 mb-6">
                    <div class="h-full p-6 md:p-12 border">
                        <div class="flex items-center">
                            <span
                                class="flex-shrink-0 inline-flex mr-4 md:mr-10 items-center justify-center w-20 h-20 bg-pink-300 rounded-full">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-3 mb-6 lg:mb-0">
                    <div class="h-full p-6 md:p-12 border">
                        <div class="flex items-center">
                            <span
                                class="flex-shrink-0 inline-flex mr-4 md:mr-10 items-center justify-center w-20 h-20 bg-orange-300 rounded-full">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-3">
                    <div class="h-full p-6 md:p-12 border">
                        <div class="flex items-center">
                            <span
                                class="flex-shrink-0 inline-flex mr-10 items-center justify-center w-20 h-20 bg-red-300 rounded-full">
